...
Router.get("/authors/author/:author", async (req, res) => {
...
Router.get("/authors/isbn/:isbn", async (req, res) => {
...
Router.put("/author/update/:name", async (req, res) => {
...
Router.delete("/author/delete/:name", async (req, res) => {
