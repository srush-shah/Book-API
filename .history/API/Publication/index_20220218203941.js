...
Router.get("/publications/pubname/:pubname", async (req, res) => {
...
Router.get("/publications/isbn/:isbn", async (req, res) => {
...
Router.put("/publication/update/:name", async (req, res) => {
...
Router.put("/publication/book/update/:pubid", async (req, res) => {
...
Router.delete("/publication/delete/:name", async (req, res) => {
...
Router.delete("/publication/book/delete/:isbn/:pubid", async (req, res) => {
