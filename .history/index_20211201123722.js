...
bookapi.put("/author/update/:name", (req, res) => {
  ...
  return res.json({ authors: database.authors, message: "Author updated for the book" });
});
...
bookapi.put("/publication/update/:name", (req, res) => {
  ...
  return res.json({ publications: database.publications,message: "Updated name of the publication" });
});
